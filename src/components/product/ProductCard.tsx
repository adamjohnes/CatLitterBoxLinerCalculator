...
export function ProductCard({ productId }: { productId: ProductId }) {
  ...
  return (
    <a
      ...
      className="group flex min-h-96 flex-col overflow-hidden rounded-3xl border border-stone-200 bg-white p-5 transition duration-300 hover:-translate-y-1 hover:shadow-xl focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-amber-500/40 sm:p-6"
    >
